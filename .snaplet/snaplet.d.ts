...
interface Table_public_applicant {
  id: string;
  name: string;
  email: string;
  createdAt: string;
...
interface Table_public_applicant_on_customer {
  id: string;
  applicantId: string;
  customerId: string;
  createdAt: string;
...
interface Tables_relationships {
  "public.Applicant": {
    ...
    children: {
       ApplicantOnCustomer_applicantId_fkey: "public.ApplicantOnCustomer";
    };
  };
  "public.ApplicantOnCustomer": {
    parent: {
       ApplicantOnCustomer_applicantId_fkey: "public.Applicant";
       ApplicantOnCustomer_customerId_fkey: "public.Customer";
    };
    children: {
  ...
  "public.Customer": {
    ...
    children: {
       ApplicantOnCustomer_customerId_fkey: "public.ApplicantOnCustomer";
    };
  };
  "storage.buckets": {
    parent: {
